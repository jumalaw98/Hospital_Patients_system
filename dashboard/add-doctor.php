...
if (isset($_POST['submit'])) {
    ...
    $userPosCode=$_POST['postalCode'];
    $userPhone=$_POST['phone'];
    $userPic=$_FILES['UserImg']['name'];
    $userBio=$_POST['Bio'];
    $userStats=$_POST['status'];
    $SuccMessage="Data Added Succesfully";

$sql = "INSERT INTO doctor (doctor_name,department,	userName,email,pass,dateOfBirth,gender,addrss,city,Province,postalCode,phone,profilePic,shortBio,docStatus) VALUES ('$docName','$deptName','$userName','$userMail','$userPass','$userDob','$userGender','$userAddrss','$userCity','$userState','$userPosCode','$userPhone','$userPic','$userBio',' $userStats')";
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="doctorname" required>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                       ...
                                       <select class="select" name="departmentname">
											...
											<option value="doctor_name">select</option>
 <?php  
                          ...
                          ?>
                                ...
                                <div class="col-sm-6">
									<div class="form-group gender-select" required>
                            ...
                            <div class="form-group">
								...
								<div class="form-check form-check-inline">
									<input class="form-check-input" type="radio" name="status" id="doctor_active" value="Active" required>
									<label class="form-check-label" for="doctor_active">
									Active
									</label>
								</div>
								<div class="form-check form-check-inline">
									<input class="form-check-input" type="radio" name="status" id="doctor_inactive" value="Inactive" required>
...
<!-- Mirrored from dreamguys.co.in/preclinic/template/add-doctor.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 23 Jul 2019 17:14:36 GMT -->
</html>
