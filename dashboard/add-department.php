                        ...
                        <form method="POST"> 
                            ...
                            <div class="form-group">
								...
								<div class="form-check form-check-inline">
									<input class="form-check-input" type="radio" name="deptstatus" id="deptstatus" value="Active">
									<label class="form-check-label" for="product_active">
									Active
									</label>
								</div>
								<div class="form-check form-check-inline">
									<input class="form-check-input" type="radio" name="deptstatus" id="deptstatus" value="Inactive">
                            ...
                            <div class="m-t-20 text-center">
                                <button class="btn btn-primary submit-btn" type="submit" name="submit" id="submit">Create Department</button>
                            </div>
                        </form>
                    </div>
                </div>
...
<!-- Mirrored from dreamguys.co.in/preclinic/template/add-department.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 23 Jul 2019 17:14:36 GMT -->
</html>
