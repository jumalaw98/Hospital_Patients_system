...
if (isset($_POST['submit'])) {
    ...
    $empAge=$_POST['empAge'];
    $empUsrName=$_POST['empUsrName'];
    $empMail=$_POST['empMail'];
    $empPass=$_POST['password'];
    $empJdate=$_POST['joinDate'];
    $empPhone=$_POST['empPhone'];
    $empRole=$_POST['empRole'];
    $empStatus=$_POST['status'];
    $SuccMessage="Data Added Succesfully";

$sql = "INSERT INTO employee (empName,age,userName,email,password,joinDate,phone,role,empStatus) VALUES ('$empName','$empAge','$empUsrName',
'$empMail','$empPass','$empJdate','$empPhone','$empRole','$empStatus')";

if ($conn->query($sql)) {
    echo  "<script type='text/javascript'>alert('$SuccMessage');</script>";
	echo "<script>location='employees.php'</script>";
} else {
                        ...
                        <form method="post">
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label>Age</label>
                                        <input class="form-control" type="number" name="empAge" required>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label>Username <span class="text-danger">*</span></label>
                                        <input class="form-control" type="text" name="empUsrName" required>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label>Email <span class="text-danger">*</span></label>
                                        <input class="form-control" type="email" name="empMail" required>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="cal-icon">
                                            <input class="form-control datetimepicker" type="text" name="joinDate" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        <label>Role</label>
                                        <select class="select" name="empRole" required>
                                            <option>Admin</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="status" id="employee_active" value="Active" required>
                                        <label class="form-check-label" for="employee_active">
                                        Active
                                        </label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="status" id="employee_inactive" value="Inactive" required>
                            ...
                            <div class="m-t-20 text-center">
                                <button class="btn btn-primary submit-btn" name="submit">Create Employee</button>
                            </div>
                        </form>
                    </div>
                </div>
...
<!-- Mirrored from dreamguys.co.in/preclinic/template/add-employee.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 23 Jul 2019 17:14:36 GMT -->
</html>
