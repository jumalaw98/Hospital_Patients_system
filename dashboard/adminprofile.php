...
<!-- Mirrored from dreamguys.co.in/preclinic/template/profile.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 23 Jul 2019 17:13:24 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <div class="main-wrapper">
        ...
        <div class="page-wrapper">
            <div class="content">
				...
				<?php
					$tempId=$_SESSION['id'];
					$sql = "SELECT * FROM `admin` WHERE admin_id = '$tempId'";  
                                    ...
                                    <div class="row">
                                        <div class="col-md-5">
                                            <div class="profile-info-left">
                                                <h3 class="user-name m-t-0 mb-0"><?php echo $row['adminName']; ?></h3>
                                                <small class="text-muted">Role : Admin</small>
                                                <div class="staff-id">Admin ID : <?php echo $row['admin_id']; ?></div>
                                                <div class="staff-msg"><a href="index.php" class="btn btn-primary">Access DashBoard</a></div>
                                            </div>
                                        </div>
                                        <div class="col-md-7">
                                            <ul class="personal-info">
                                                <li>
                                                    ...
                                                    <span class="text"><a href="#"><?php echo $row['adminPhone']; ?></a></span>
                                                </li>
                                                <li>
                                                ...
                                                <li>
                                                    ...
                                                    <span class="text"><?php echo $row['adminDob']; ?></span>
                                                </li>
                                                <li>
                                                   <!-- <span class="title">Address:</span>
                                                    <span class="text"><?php echo $row['addrss']; ?></span>-->
                                                </li>
                                                <li>
...
<!-- Mirrored from dreamguys.co.in/preclinic/template/profile.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 23 Jul 2019 17:13:26 GMT -->
</html>