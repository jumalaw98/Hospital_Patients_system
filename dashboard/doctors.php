        ...
        <div class="page-wrapper" style="min-height: 657px;">
                ...
                ?>
                    ...
                    <div class="col-md-4 col-sm-4  col-lg-3">
                        <div class="profile-widget">
                            ...
                            <h4 class="doctor-name text-ellipsis"><a href="profile.html"><?php echo $docname ?></a></h4>
            ...
            <div class="notification-box">
                <div class="msg-sidebar notifications msg-noti">
                    ...
                    <div class="slimScrollDiv" style="position: relative; overflow: hidden; width: auto; height: 533px;"><div class="drop-scroll msg-list-scroll" id="msg_list" style="overflow: hidden; width: auto; height: 533px;">
                        <ul class="list-box">
                            <li>
                                <a href="chat.html">
                                    <div class="list-item">
                    ...
                    </div><div class="slimScrollBar" style="background: rgb(135, 135, 135); width: 4px; position: absolute; top: 0px; opacity: 0.4; display: none; border-radius: 0px; z-index: 99; right: 1px; height: 848px;"></div><div class="slimScrollRail" style="width: 4px; height: 100%; position: absolute; top: 0px; display: none; border-radius: 7px; background: rgb(51, 51, 51); opacity: 0.2; z-index: 90; right: 1px;"></div></div>
                    <div class="topnav-dropdown-footer">
...
<!-- Mirrored from dreamguys.co.in/preclinic/template/doctors.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 23 Jul 2019 17:13:42 GMT -->
</body>
