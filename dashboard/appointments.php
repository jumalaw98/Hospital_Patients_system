...
<!-- Mirrored from dreamguys.co.in/preclinic/template/appointments.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 23 Jul 2019 17:13:43 GMT -->
<head>
    <meta charset="utf-8">
						...
						<div class="table-responsive">
                          ...
                          ?>  
									<tr>
										...
										<td><span class="custom-badge status-red"><?php echo $row['status']; ?></span></td>
										<?php }
                                         else{
										 ?>
										 <td class="sorting_1"><span class="custom-badge status-green"><?php echo $row['status']; ?></span></td>
                                         <?php } ?>
										<!--<td class="text-right">
...
<!-- Mirrored from dreamguys.co.in/preclinic/template/appointments.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 23 Jul 2019 17:13:44 GMT -->
</html>